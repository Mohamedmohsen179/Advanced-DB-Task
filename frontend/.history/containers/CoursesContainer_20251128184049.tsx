          ...
          <div className="flex flex-wrap gap-4 items-center">
            <div>
              ...
              <select
                ...
                className="border border-slate-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200 bg-white"
              >
