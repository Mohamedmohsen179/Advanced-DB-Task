           ...
           transition-all duration-200 bg-white shadow-sm"
              ...
              <div className="md:col-span-2">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="text-black mt-1 block w-full border border-slate-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-slate-100 focus:border-slate-500 transition-all duration-200 bg-white shadow-sm"
                >
