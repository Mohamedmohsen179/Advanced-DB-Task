  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-3 border-l-red-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-3 border-l-purple-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
