        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-blue-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Students</p>
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-green-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Doctors</p>
                <p className="text-2xl font-bold text-slate-900">{stats.doctorsCount}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-purple-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Courses</p>
                <p className="text-2xl font-bold text-slate-900">{stats.coursesCount}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-orange-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Courses Schedules</p>
                <p className="text-2xl font-bold text-slate-900">{stats.activeCoursesCount}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
              ...
              <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Add a new doctor</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link href="/doctors/new">
              <div className="p-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                    <span className="text-green-600 text-xl">👨‍🏫</span>
                  </div>
        ...
        <Link href="/doctors">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-500">
                Manage Faculty Doctors, their profiles, and teaching assignments
              </p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/courses">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-500">
                Manage Course offerings, schedules, enrollment and other details
              </p>
            </CardContent>
          </Card>
        </Link>
