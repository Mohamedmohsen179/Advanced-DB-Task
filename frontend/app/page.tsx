  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center lg:text-left">
        <h1 className="text-4xl font-bold text-slate-900 tracking-tight">Welcome to University Management System</h1>
        <p className="mt-3 text-lg text-slate-600 max-w-2xl">
          Manage students, faculty, and courses all in one place with our comprehensive management platform.
        </p>
      </div>
        ...
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-green-500">
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Faculty Members</p>
            ...
            <Link href="/doctors/new">
              <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-gray-900">Add Faculty</h3>
